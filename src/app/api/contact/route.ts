									...
									<table cellpadding="0" cellspacing="0" border="0" style="width: 100%; background: linear-gradient(135deg, #667eea 0%, #764ba2 100%);">
										<tr>
											<td style="padding: 40px 32px; text-align: center;">
												...
												<h1 style="margin: 0; font-size: 28px; font-weight: 700; color: #ffffff; letter-spacing: -0.025em;">New Contact Message</h1>
												<p style="margin: 8px 0 0 0; color: rgba(255, 255, 255, 0.9); font-size: 16px;">You have received a new message from your portfolio</p>
											</td>
										</tr>
									</table>
													...
													<table cellpadding="0" cellspacing="0" border="0" style="width: 100%;">
														<tr>
															<td style="padding: 0 0 16px 0;">
																<div style="display: inline-block; background-color: #667eea; color: white; padding: 4px 12px; border-radius: 20px; font-size: 12px; font-weight: 600; text-transform: uppercase; letter-spacing: 0.05em;">Contact Info</div>
															</td>
														</tr>
														<tr>
															<td style="padding: 0;">
																	...
																	<tr>
																		<td style="padding: 12px 0; vertical-align: top; width: 100px;">
																			<div style="display: flex; align-items: center; justify-content: flex-start;">
																				...
																				<strong style="color: #374151; font-size: 14px; font-weight: 600;">Name</strong>
																			</div>
																		</td>
																	...
																	<tr>
																		<td style="padding: 12px 0; vertical-align: top;">
																			<div style="display: flex; align-items: center; justify-content: flex-start;">
																				...
																				<strong style="color: #374151; font-size: 14px; font-weight: 600;">Subject</strong>
																			</div>
																		</td>
																		<td style="padding: 12px 0; font-size: 15px; color: #111827; font-weight: 500;">
																			${subject}
										...
										<tr>
											<td style="padding: 0;">
												<div style="background-color: #ffffff; border: 2px solid #e5e7eb; border-radius: 12px; padding: 28px; position: relative;">
													<div style="position: absolute; top: -12px; left: 24px; background-color: #ffffff; padding: 0 12px; font-size: 12px; font-weight: 700; color: #667eea; text-transform: uppercase; letter-spacing: 0.1em;">Message</div>
											...
											<td style="text-align: center;">
												<div style="background: linear-gradient(135deg, #f8fafc 0%, #f1f5f9 100%); border-radius: 12px; padding: 20px; border: 1px solid #e5e7eb;">
													<div style="display: inline-block; margin-bottom: 8px;">
														...
														<span style="font-size: 12px; font-weight: 600; color: #059669; text-transform: uppercase; letter-spacing: 0.05em;">Auto Reply Enabled</span>
													</div>
													<p style="margin: 0; font-size: 14px; color: #6b7280; line-height: 1.5;">
														This message was received via your portfolio contact form.<br>
														<strong style="color: #374151;">Reply directly to this email</strong> to respond to ${name}.
													</p>
												</div>
											</td>
										</tr>
										...
										<tr>
											<td style="text-align: center;">
												<p style="margin: 0; font-size: 12px; color: #9ca3af;">
													Powered by TPIT Portfolio • ${new Date().toLocaleDateString('en-US', { year: 'numeric', month: 'long', day: 'numeric' })}
												</p>
											</td>
										</tr>
									</table>
